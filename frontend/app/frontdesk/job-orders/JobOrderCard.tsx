...
import { STATUS_CONFIG, getInspectionProgress } from "./jobOrderHelpers";
...
export const JobOrderCard: React.FC<JobOrderCardProps> = ({ jo, onClick }) => {
        ...
        <div className="space-y-2 text-xs border-t border-slate-100 pt-3">
          ...
          <div className="space-y-1.5 pt-1">
            ...
            <div className="flex flex-wrap gap-1">
              {(jo.inchargeMechanics || []).map((mech: string, idx: number) => (
                <span
                  key={idx}
